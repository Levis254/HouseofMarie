...
export const products: Product[] = [
  {
    ...
    description: 'Marie No. 1 is the signature formulation of the House. It represents the duality of brightness and depth, blending delicate floral petals with heavy amber elements for a scent trail that lingers beautifully. Every spray is a step into a dimly lit avenue of gold reflections.',
    notes: {
  ...
  },
  {
    ...
    description: 'Our most opulent fragrance. Marie No. 3 is created for those who demand ultimate presence and luxury. The natural Damascus rose oil combines with pure Cambodian oudh and warm incense for a majestic, regal presence.',
    notes: {
